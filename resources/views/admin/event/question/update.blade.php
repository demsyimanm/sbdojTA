...
<div style="padding-left:20%;padding-right:20%;">
  <h1 class="ui dividing header">
    ...
    <div class="content" >
      Update Pertanyaan event "{{$eve->judul}}"
    </div>
  </h1>
  <br>
              ...
              <div class="sixteen wide field">
                <div class="inline fields">
                  ...
                  <div class="thirteen wide field">
                    <input type="text" name="judul" placeholder="Judul Pertanyaan" value="{{$quest->judul}}">
                  </div>
                </div>
              </div>
              <div class="sixteen wide field">
                <div class="inline fields">
                  ...
                  <div class="thirteen wide field">
                    <textarea type="text" name="konten" style="resize:vertical;">{{$quest->konten}}</textarea>
                  </div>
                </div>
              </div>
              <div class="sixteen wide field">
                <div class="inline fields">
                  ...
                  <div class="thirteen wide field">
                    ...
                    <textarea name="jawaban">{{$quest->jawaban}}</textarea>
                  </div>
                </div>
              </div>
              {{csrf_field()}}
