...
<div style="padding-left:20%;padding-right:20%;">
  <h1 class="ui dividing header">
    ...
    <div class="content" >
      Update Soal Tutorial "{{$event->name}}"
    </div>
  </h1>
  <br>
                  ...
                  <div class="four wide field">
                      <select class="" name="category">
                        @foreach($categories as $category)
                          @if($category->id == $tutorial->category->id)
              ...
              <div class="sixteen wide field">
                <div class="inline fields">
                  ...
                  <div class="thirteen wide field">
                    <input type="text" name="judul" placeholder="Judul" value="{{$tutorial->judul}}">
                  </div>
                </div>
              </div>
              <div class="sixteen wide field">
                <div class="inline fields">
                  ...
                  <div class="thirteen wide field">
                    <textarea type="text" name="konten" placeholder="Konten" style="resize:vertical;">{{$tutorial->konten}}</textarea>
                  </div>
                </div>
              </div>
              <div class="sixteen wide field">
                <div class="inline fields">
                  ...
                  <div class="thirteen wide field">
                    ...
                    <textarea name="jawaban">{{$tutorial->jawaban}}</textarea>
                  </div>
                </div>
              </div>
              {{csrf_field()}}
