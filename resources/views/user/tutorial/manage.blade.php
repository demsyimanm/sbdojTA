		  ...
		  <tbody>
		  	...
		  	@foreach ($tutorials as $eve)
			    ...
			    <tr>
		      		...
		      		@else
		      			<td><a href="{{ URL::to('tutorial/manage/'. $eve->id) }}" >{{ $eve->judul }}</td>
		      		@endif
		      		<?php
		      		...
		      		<td>
				      	<center>
				      		...
				      		@else
				      			<a href="{{ URL::to('tutorial/manage/'. $eve->id) }}" class="ui right labeled icon primary button"><i class="right arrow icon" style="height:135%"></i> Pilih</a>
				      		@endif
				      		<a href="{{ URL::to('tutorial/submissions/'. $eve->id) }}" class="ui right labeled icon green button"><i class="right arrow icon" style="height:135%"></i> Lihat Submission</a>
				      	</center>
			      	</td>
			    </tr>
		    @endforeach
